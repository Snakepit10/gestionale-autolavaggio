...
# Email (notifiche cliente prenotazioni)
# In dev usa console (le email appaiono in stdout del runserver).
# In produzione configura SMTP via env vars.
...
# gestionale non vengono approvati da Meta (24-72h). Disattivare in
# produzione.
